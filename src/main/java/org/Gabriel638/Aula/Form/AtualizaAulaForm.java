package org.Gabriel638.Aula.Form;
...
public class AtualizaAulaForm {
	...
	public Aula atualizar(int id, AulaRepository repositorio) {
		Aula produto = repositorio.getOne(id);
